...
async def test_create_legacy_integrated_spec_with_a_dict_embed_redirects_the_same_way(
    indexes: AsyncIndexes,
) -> None:
...
async def test_create_legacy_integrated_spec_with_an_unreadable_embed_still_redirects(
    indexes: AsyncIndexes,
) -> None:
...
async def test_create_legacy_pod_spec_source_collection_is_guided_away(
    indexes: AsyncIndexes,
) -> None:
...
async def test_create_legacy_pod_spec_metadata_config_is_guided_away(
    indexes: AsyncIndexes,
) -> None:
