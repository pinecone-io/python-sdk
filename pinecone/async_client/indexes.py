...
class AsyncIndexes:
    ...
    def list(
        ...
        *,
        ...
        :class:`~pinecone.models.pagination.AsyncPaginator` always yields
        exactly one page and then terminates; the paginator interface is used
        for consistency with other list methods and forward compatibility.
        ...
        **legacy_kwargs: Any,
        ...
        .. versionchanged:: 10.0
           ...
           .. code-block:: python
               ...
               # 9.x
               await pc.indexes.create(name="movies", dimension=1536,
    ...
    async def create_backup(
        ...
        *,
        ...
        Index-scoped convenience for :meth:`AsyncPinecone.backups.create`,
        which takes the same arguments as keywords and reaches the same
        endpoint.
    ...
    async def describe_backup(self, backup_id: str) -> BackupModel:
        ...
        Index-scoped alias of :meth:`AsyncPinecone.backups.describe`; the
        endpoint is keyed by backup id, not by index.
