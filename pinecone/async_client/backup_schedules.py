...
attaches a recurring backup cadence to one index. The API supports exactly one
schedule *type* (``"time-based"``) and three cadences (``daily``, ``weekly``,
``monthly``); the run time is chosen server-side and reported through
